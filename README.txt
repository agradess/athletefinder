...
If an athlete is found in the database, or a part of the full name is searched and only one result is found,
then the athlete's name, along with a thumbnail photo and a description are shown. If what the user entered did not return
any results in the database, an error page is displayed, and the user is prompted to search again. Each time an athlete is successfully
found, the athlete is added to the MongoDB database. [TBD] I have plans to list the search history and retrieve all the documents in
the database, or perhaps the 50 most recent searches.

Have fun browsin' athletes!

# API Link:

The SportsDB - Simple Sports Art and Metadata: https://www.thesportsdb.com/api.php
...
Link: https://youtu.be/-STQZyal-o4




Google font README info:
